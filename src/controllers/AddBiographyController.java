...
/**
 * Servlet implementation class AddBiographyController
 */
//@WebServlet("/AddBiographyController")
public class AddBiographyController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddBiographyController() {
        super();
