...
/**
 * Servlet implementation class AddLiteratureController
 */
//@WebServlet("/AddLiteratureController")
public class AddLiteratureController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddLiteratureController() {
        super();
