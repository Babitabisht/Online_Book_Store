...
<a href="Novel.jsp" class="dropdown-item" id="tollfree">Biographies, Diaries & True Accounts</a>
<a href="" class="dropdown-item" id="email">Action & Adventure</a>
<a href="" class="dropdown-item" id="email">Computing, Internet & Digital Media</a>
<a href="" class="dropdown-item" id="email">Literature & Fiction</a>
<a href="" class="dropdown-item" id="email">Religion</a>
