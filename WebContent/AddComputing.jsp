...
<title>Add Computing Book</title>
...
<div class="card-header"><p class="display-4 text-center">Add a new  book on Computing , Internet and Digital Media</p></div>
<div class="card-body">
<form action="AddComputingController" method="post" >
