...
<title>Add Literature Books</title>
</head>
<body>
...
<div class="card-header"><p class="display-4 text-center">Add a new  book on Literature and Fiction</p></div>
<div class="card-body">
<form action="AddLiteratureController" method="post" >
...
<input type="text" name="d_descp" id="" placeholder="detailed description" class="form-control"  required /><br />
