...
<title>Add Religious Books</title>
...
<div class="card-header"><p class="display-4 text-center">Add a new  book on Religion</p></div>
<div class="card-body">
<form action="AddReligionController" method="post" >
