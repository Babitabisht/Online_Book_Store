...
<div class="card-header"><p class="display-4 text-center">Add a new  book on Action and Adventure</p></div>
<div class="card-body">
<form action="AddActionController" method="post" >
